...
<div class="container clearfix">
    ...
    <div class="result-wrap">        
            <div class="result-content">
                <form action="<?php echo U('/admin/ThreeCate/addAct');?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
        ...
        <script type="text/javascript">
            $("#hight").change(function(){
                ...
                $.ajax({
                    url:'/nwe/index.php/admin/ThreeCate/getMiddleCate',
                    type:'POST',
