...
<div class="container clearfix">
    ...
    <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('admin/index/index');?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">一级目录</span></div>
    </div>
            ...
            <div class="result-content">
                <table class="result-tab" width="100%">
                    ...
                    <?php if(is_array($hcates)): foreach($hcates as $key=>$hcate): ?><tr>
                        ...
                        <td>admin</td>
                        <td><?php echo (date("Y-m-d H:i:s",$hcate['created_at'])); ?></td>
                        <td><?php echo (date("Y-m-d H:i:s",$hcate['updated_at'])); ?></td>
                        <td>
                            <a class="link-update" href="<?php echo U('Admin/cate/save',[ 'id'=>$hcate['id'] ]);?>">修改</a>
                            <a class="link-del" href="<?php echo U('Admin/cate/del',[ 'id'=>$hcate['id'] ]);?>">删除</a>
                        </td>
